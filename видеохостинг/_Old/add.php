...
$d1='';$d2='';$d3='';$d4='';$d5='';
if($r=="streams"){$d1=' SELECTED';}
if($r=="peredach"){$d2=' SELECTED';}
if($r=="games"){$d3=' SELECTED';}
if($r=="humour"){$d4=' SELECTED';}
...
echo'<option value="streams"'.$d1.'>Стримы</option>';
/*echo'<option value="peredach"'.$d2.'>Передачи</option>';*/
echo'<option value="games"'.$d3.'>Игры</option>';
/*echo'<option value="humour"'.$d4.'>Юмор</option>';*/
/*echo'<option value="bloggers"'.$d5.'>Блоггеры</option>';*/
echo'</select>';
