...
if(@$_SESSION['user_id']==2){$ch=1;}else{$ch=0;}
try{$data = array($n,$a,$co,$c,$s,$r,$ch);
$STH = $DBH->prepare("INSERT INTO streams (nazv,about,code,cat_id,subcat_id,razdel,check_) values (?,?,?,?,?,?,?)");
