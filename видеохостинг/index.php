...
function menu(razdel) {
	...
	if(data!=''){
		...
		if(!razdel){document.getElementById('pict').innerHTML='<img src=images/slide1.png>';}
		if(razdel=='streams'){document.getElementById('pict').innerHTML='<img src=images/slide2.png>';}
...
<div id="parent_popup"><div id="popup">&nbsp;</div></div>
		...
		<div class="shell">
			...
			<div id="header">
				<div id="logo">
					...
					<p>Самое полезное учебное видео из Всемирной Сети</p>
				</div>
				<div id=mmenu></div>
			</div>
			<!-- End Header -->
	...
	<div id="main-holder">
		<!-- Begin Shell -->
		<div class="shell">
	<div id=pict width=980 height=300 style="position: absolute; top: 165px;"></div>
		...
		<div id="window" style="align:center; position: absolute; top: 485px;"></div>
							</td></tr></table>
					</div>
